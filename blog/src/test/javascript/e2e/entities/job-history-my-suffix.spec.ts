...
describe('JobHistory e2e test', () => {
    ...
    it('should load JobHistories', () => {
        ...
        expect(jobHistoryComponentsPage.getTitle()).toMatch(/blogApp.jobHistory.home.title/);
    ...
    it('should load create JobHistory dialog', () => {
        ...
        expect(jobHistoryDialogPage.getModalTitle()).toMatch(/blogApp.jobHistory.home.createOrEditLabel/);
