...
describe('Country e2e test', () => {
    ...
    it('should load Countries', () => {
        ...
        expect(countryComponentsPage.getTitle()).toMatch(/blogApp.country.home.title/);
    ...
    it('should load create Country dialog', () => {
        ...
        expect(countryDialogPage.getModalTitle()).toMatch(/blogApp.country.home.createOrEditLabel/);
