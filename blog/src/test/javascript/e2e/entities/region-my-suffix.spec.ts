...
describe('Region e2e test', () => {
    ...
    it('should load Regions', () => {
        ...
        expect(regionComponentsPage.getTitle()).toMatch(/blogApp.region.home.title/);
    ...
    it('should load create Region dialog', () => {
        ...
        expect(regionDialogPage.getModalTitle()).toMatch(/blogApp.region.home.createOrEditLabel/);
