...
describe('Employee e2e test', () => {
    ...
    it('should load Employees', () => {
        ...
        expect(employeeComponentsPage.getTitle()).toMatch(/blogApp.employee.home.title/);
    ...
    it('should load create Employee dialog', () => {
        ...
        expect(employeeDialogPage.getModalTitle()).toMatch(/blogApp.employee.home.createOrEditLabel/);
