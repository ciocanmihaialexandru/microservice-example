...
describe('Location e2e test', () => {
    ...
    it('should load Locations', () => {
        ...
        expect(locationComponentsPage.getTitle()).toMatch(/blogApp.location.home.title/);
    ...
    it('should load create Location dialog', () => {
        ...
        expect(locationDialogPage.getModalTitle()).toMatch(/blogApp.location.home.createOrEditLabel/);
