...
public class JobHistoryResourceIntTest {
    ...
    public void createJobHistory() throws Exception {
        ...
        assertThat(testJobHistory.getStartDate()).isEqualTo(testJobHistory.getStartDate());
        assertThat(testJobHistory.getEndDate()).isEqualTo(testJobHistory.getEndDate());
        assertThat(jobHistoryEs).isEqualToIgnoringGivenFields(testJobHistory, "startDate", "endDate");
    }
